...
export function createPrivateContext(vm: VM | null) {
    ...
    return {
        ...
        updateVariable() {
            for (const variable of this.variables) {
                wrappedVM.get().setMetadata(variable.reference.target, variable.reference.name, "description", variable.description);
            }
        },
    };
}